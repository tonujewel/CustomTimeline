...
class ProgressTimelineTopTitle extends StatefulWidget {
  /// a List of all states to be rendered
  final List<SingleStateNew> states;
...
void currentStage(int currentStage) {
  ...
  @override
  _ProgressTimelineTopTitleState createState() => state;
}

class _ProgressTimelineTopTitleState extends State<ProgressTimelineTopTitle> {
  int currentStageIndex = 0;
  List<SingleStateNew> states;
  double height = 100;
...
class SingleStateNew {
  ...
  SingleStateNew({@required this.stateTitle, this.isFailed});
}
